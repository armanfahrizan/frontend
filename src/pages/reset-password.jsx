...
function ResetPassword () {
    ...
    const userId = pathname.split('/reset/')[1]
    const emailUser = pathname.split('/reset/')[2]
    ...
    const onResetButton = async() => {
        ...
        await axios.patch(API_URL + `/reset/verify/${userId}`, bodyOnReset)
        .then((resp) => {
            setSending(false)
